...
<body>
	<%
		List<RentCar_Dto> list = (List<RentCar_Dto>)request.getAttribute("list");
		...
		List<RentCar_Dto> list2 = list.subList(pm.startRow-1, pm.endRow);
